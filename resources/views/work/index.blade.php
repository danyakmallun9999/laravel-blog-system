            ...
            <div class="space-y-8">
                @foreach ($works as $work)
                    <a href="{{ route('work.show', $work) }}" class="group block">
                        <article>
                            <div
                                class="flex flex-col lg:flex-row gap-8 items-start border border-gray-200 p-3 rounded-2xl">
                                <!-- Project Image -->
                                <div class="lg:w-1/2">
                                    <div
                                ...
                                <div class="lg:w-1/2 lg:pt-4">
                                    <!-- Title -->
                                    <h2
                                        class="text-2xl lg:text-3xl font-bold text-gray-900 mb-4 leading-tight transition-colors group-hover:text-red-500">
                                        {{ $work->title }}
                                    </h2>
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <div class="flex flex-wrap gap-2">
                                                @foreach (explode(',', $work->technologies) as $tech)
                                                    <span
                                                        class="inline-block px-3 py-1 text-xs bg-gray-100 text-gray-700 rounded-lg">
                                                        {{ trim($tech) }}
                                                    </span>
                                                @endforeach
                                            </div>

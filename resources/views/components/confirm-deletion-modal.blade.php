...
<div x-show="show" x-cloak {{-- Menambahkan watcher untuk menangani scrollbar saat modal dibuka/ditutup --}} x-init="$watch('show', value => {
    if (value) {
        ...
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            <div x-show="show" @click.outside="show = false" x-transition:enter="ease-out duration-300"
                ...
                <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                    {{-- Slot untuk tombol-tombol yang sudah di-styling dengan baik --}}
                    {{ $footer }}
                </div>
            </div>
        </div>

        ...
        <div class="min-h-screen">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <!-- Desktop Navigation -->
                            {{-- Mengurangi spasi agar lebih muat di layar medium --}}
                        ...
                        <div class="flex items-center">
                                ...
                                <x-dropdown align="right" width="48">
                                    <x-slot name="trigger">
                                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-slate-600  bg-white  hover:text-slate-800  focus:outline-none transition ease-in-out duration-150">
                                            <div class="h-8 w-8 rounded-full bg-slate-200  flex items-center justify-center mr-2">
                                                @if(Auth::user()->avatar)
                            ...
                            <div class="sm:hidden flex items-center">
                                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-slate-400 hover:text-slate-500 hover:bg-slate-100  focus:outline-none focus:ring-2 focus:ring-inset focus:ring-slate-500 transition">
            ...
            @isset($header)
                <header class="bg-white shadow-sm">
                    ...
                    <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
                        {{-- Dibuat flex-wrap agar bisa turun ke bawah di mobile --}}
            ...
            <!-- Page Content -->
                <main class="flex-1 relative overflow-y-auto focus:outline-none">
                    <div class="py-6">
                        {{-- ==================== PERBAIKAN DI SINI ==================== --}}
                        {{-- Menambahkan `px-4` sebagai padding dasar untuk semua layar (mobile-first) --}}

        ...
        <div class="min-h-screen flex">
            <div class="w-full lg:w-1/2 flex items-center justify-center px-6 sm:px-8 py-12 bg-white shadow-2xl lg:shadow-none z-20">
                <div class="w-full max-w-md">
                    {{ $slot }} {{-- Konten dari login.blade.php atau register.blade.php --}}
                </div>
            </div>

            <div class="hidden lg:flex lg:w-1/2 relative items-stretch justify-center rounded-2xl xl:rounded-l-3xl overflow-hidden m-6">
                ...
                <div class="absolute inset-0 opacity-40 z-1"> {{-- Opasitas sedikit disesuaikan --}}
                    <svg class="absolute bottom-0 w-full h-auto max-h-full" viewBox="0 0 400 300" preserveAspectRatio="xMidYEnd slice">
                        <path d="M0,200 Q100,120 200,140 Q300,160 400,100 L400,300 L0,300 Z" fill="rgba(255,255,255,0.03)"/>
                    </svg>
                    <svg class="absolute bottom-0 w-full h-auto max-h-full" viewBox="0 0 400 300" preserveAspectRatio="xMidYEnd slice">
                        <path d="M0,250 Q80,180 160,200 Q240,220 320,170 Q360,150 400,160 L400,300 L0,300 Z" fill="rgba(255,255,255,0.05)"/>
                    </svg>
                    <svg class="absolute bottom-0 w-full h-auto max-h-full" viewBox="0 0 400 300" preserveAspectRatio="xMidYEnd slice">
                        <path d="M0,280 Q60,220 120,240 Q180,260 240,230 Q300,200 360,210 Q380,215 400,220 L400,300 L0,300 Z" fill="rgba(255,255,255,0.07)"/>
                    </svg>
                </div>

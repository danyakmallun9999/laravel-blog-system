<x-public-layout>
    <div class="flex items-center justify-center min-h-[60vh] sm:min-h-[70vh] px-6 py-16">
        <div class="max-w-lg mx-auto text-center">
            ...
            <div class="mb-8">
                <i class="fas fa-hand-paper text-6xl sm:text-7xl text-red-500"></i>
            </div>

            {{-- Kode Error dan Judul --}}
            <p class="text-sm font-semibold text-slate-500 uppercase tracking-wider mb-2">Error 403</p>
            ...
            <p class="text-slate-600 mb-8 leading-relaxed">
                Mohon maaf, Anda tidak memiliki izin untuk mengakses halaman ini. Silakan hubungi administrator jika
                Anda merasa ini adalah sebuah kesalahan.
            </p>

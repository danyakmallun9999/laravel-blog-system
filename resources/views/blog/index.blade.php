    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-8">
        ...
        <div class="mb-12">
            ...
            <div class="hidden md:flex flex-wrap items-center gap-3">
                <a href="{{ route('blog.index') }}" class="inline-block px-4 py-2 text-sm font-medium {{ !request('category') ? 'bg-gray-800 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }} rounded-lg transition">All</a>
                @foreach($categories as $category)

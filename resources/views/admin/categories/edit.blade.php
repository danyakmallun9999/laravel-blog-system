    ...
    <div class="py-2">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="px-6 py-4 border-b border-slate-200 bg-slate-50">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <i class="fas fa-edit text-slate-600 mr-3 text-xl"></i>
                            <div>
                        ...
                        <div class="text-right">
                            ...
                            <span
                                class="text-xs font-mono bg-slate-200 text-slate-700 px-2 py-1 rounded">{{ $category->slug }}</span>
                        </div>
                    </div>
                </div>
                    ...
                    <form method="POST" action="{{ route('admin.categories.update', $category) }}" class="space-y-6">
                        ...
                        <div class="bg-slate-50 rounded-lg p-4 border border-slate-200">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div class="flex items-center">
                                    <i class="fas fa-newspaper text-slate-500 mr-2.5"></i>
                                    <div>
                                        <p class="text-xs text-slate-500">Total Posts</p>
                                        <p class="text-sm font-medium text-slate-800">{{ $category->posts()->count() }}
                                        </p>
                                    </div>
                                </div>
                                <div class="flex items-center">
                                    <i class="fas fa-calendar-alt text-slate-500 mr-2.5"></i>
                                    <div>
            ...
            @if ($category->posts()->count() > 0)
                <div class="mt-6 bg-yellow-50 rounded-xl border border-yellow-300 p-6 shadow-sm">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <ul class="text-sm text-yellow-700 space-y-1 list-disc list-inside">
                                ...
                                <li>Deleting this category will affect all associated posts. Ensure posts are reassigned
                                    or this is intended.</li>

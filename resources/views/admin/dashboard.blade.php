        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    <a href="{{ route('admin.posts.create') }}" class="flex flex-col items-center justify-center text-center p-4 rounded-lg border border-slate-200 hover:bg-slate-50 hover:border-slate-300 transition-colors group min-h-[120px]">
                        <i class="fas fa-plus text-3xl text-blue-600 mb-2 group-hover:scale-110 transition-transform"></i>
                        <span class="text-sm font-medium text-slate-700">New Post</span>
                    </a>
                    <a href="{{ route('admin.categories.create') }}" class="flex flex-col items-center justify-center text-center p-4 rounded-lg border border-slate-200 hover:bg-slate-50 hover:border-slate-300 transition-colors group min-h-[120px]">
                        <i class="fas fa-folder-plus text-3xl text-yellow-600 mb-2 group-hover:scale-110 transition-transform"></i>
                        <span class="text-sm font-medium text-slate-700">Add Category</span>
                    </a>
                    <a href="{{ route('admin.works.create') }}" class="flex flex-col items-center justify-center text-center p-4 rounded-lg border border-slate-200 hover:bg-slate-50 hover:border-slate-300 transition-colors group min-h-[120px]">
                        <i class="fas fa-briefcase text-3xl text-purple-600 mb-2 group-hover:scale-110 transition-transform"></i> 
                        <span class="text-sm font-medium text-slate-700">New Work</span>
                    </a>
                    {{-- menambahkan Quick Action lain di sini jika ada, misal untuk Users --}}
                    {{-- Contoh:
                    <a href="#" class="flex flex-col items-center justify-center text-center p-4 rounded-lg border border-slate-200 hover:bg-slate-50 hover:border-slate-300 transition-colors group min-h-[120px]">
                        <i class="fas fa-user-plus text-3xl text-green-600 mb-2 group-hover:scale-110 transition-transform"></i>

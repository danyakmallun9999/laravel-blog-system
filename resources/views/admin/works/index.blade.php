            ...
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden mx-4 sm:mx-0">
                <div class="px-6 py-4 border-b border-slate-200 bg-slate-50">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <i class="fas fa-briefcase text-purple-500 mr-3 text-xl"></i>
                            <h3 class="text-lg font-semibold text-slate-800">All Works</h3>
                        </div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            <div x-data="{ show: false }"
                                                ...
                                                <form x-ref="deleteForm"
                                                    action="{{ route('admin.works.destroy', $work) }}" method="POST"
                                                    class="inline">
                                                    @csrf @method('DELETE')
                            ...
                            <div x-data="{ show: false }" class="p-4">
                                <div class="flex gap-4">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h4 class="font-semibold text-slate-800 truncate">{{ $work->title }}</h4>
                                        <p class="text-xs text-slate-500 mt-1">
                                            <span
                                                class="font-medium bg-slate-100 px-2 py-0.5 rounded">{{ $work->year }}</span>
                ...
                @else
                    <div class="text-center py-16 px-6">
                        ...
                        <h3 class="text-xl font-medium text-slate-800 mb-2">No Works Found</h3>
                        <p class="text-slate-500 mb-6">Get started by adding your first portfolio work.</p>
                        <a href="{{ route('admin.works.create') }}"

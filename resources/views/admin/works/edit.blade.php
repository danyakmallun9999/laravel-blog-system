        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm rounded-xl border border-slate-200">
                <div class="p-6 md:p-8 text-slate-700">
                    <form method="POST" action="{{ route('admin.works.update', $work) }}" enctype="multipart/form-data"
                        class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <x-text-input id="title"
                                class="block mt-1 w-full !border-slate-300 focus:!border-slate-500 focus:!ring-slate-500"
                                type="text" name="title" :value="old('title', $work->title)" required autofocus />
                        ...
                        <div>
                            ...
                            <x-text-input id="year"
                                class="block mt-1 w-full !border-slate-300 focus:!border-slate-500 focus:!ring-slate-500"
                                type="number" name="year" :value="old('year', $work->year)" required placeholder="YYYY" />
                        ...
                        <div>
                            ...
                            <x-text-input id="category"
                                class="block mt-1 w-full !border-slate-300 focus:!border-slate-500 focus:!ring-slate-500"
                                type="text" name="category" :value="old('category', $work->category)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="project_url"
                                class="block mt-1 w-full !border-slate-300 focus:!border-slate-500 focus:!ring-slate-500"
                                type="url" name="project_url" :value="old('project_url', $work->project_url)"
                        ...
                        <div>
                            ...
                            @if ($work->image)
                                <img src="{{ asset('storage/' . $work->image) }}" alt="{{ $work->title }}"
                                    class="mt-2 h-32 w-auto rounded-md shadow-sm border border-slate-200 p-1">
                            @else
                        ...
                        <div>
                            ...
                            <x-text-input id="image" name="image" type="file"
                                class="block mt-1 w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-slate-100 file:text-slate-700 hover:file:bg-slate-200 !border-slate-300 focus:!border-slate-500 focus:!ring-slate-500"
                                accept="image/*" />

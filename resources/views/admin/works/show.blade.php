                            ...
                            <div class="md:col-span-2">
                                ...
                                <p class="text-sm text-slate-800 font-semibold">
                                    <a href="{{ $work->project_url }}" target="_blank"
                                        class="text-sky-600 hover:text-sky-800 hover:underline break-all">{{ $work->project_url }}</a>
                                </p>
                            </div>
                        @endif
                        <div>

                ...
                <div class="p-6 md:p-8 text-slate-700"> {{-- Warna teks & padding disesuaikan --}}
                    <form method="POST" action="{{ route('admin.works.store') }}" enctype="multipart/form-data" class="space-y-6"> {{-- space-y-6 untuk jarak --}}
                        ...
                        <div>
                            ...
                            <x-text-input id="year" class="block mt-1 w-full !border-slate-300 focus:!border-slate-500 focus:!ring-slate-500" type="number" name="year" :value="old('year')" required placeholder="YYYY" />
                        ...
                        <div>
                            ...
                            <x-text-input id="category" class="block mt-1 w-full !border-slate-300 focus:!border-slate-500 focus:!ring-slate-500" type="text" name="category" :value="old('category')" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="project_url" class="block mt-1 w-full !border-slate-300 focus:!border-slate-500 focus:!ring-slate-500" type="url" name="project_url" :value="old('project_url')" placeholder="https://example.com" />

                    ...
                    <form method="POST" action="{{ route('admin.works.store') }}" enctype="multipart/form-data"
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="5" required
                                class="block mt-1 w-full border-slate-300 bg-white text-slate-700 focus:border-slate-500 focus:ring-slate-500 rounded-md shadow-sm">{{ old('description') }}</textarea>
                        ...
                        <div>
                            ...
                            <x-text-input id="year"
                                class="block mt-1 w-full !border-slate-300 focus:!border-slate-500 focus:!ring-slate-500"
                                type="number" name="year" :value="old('year')" required placeholder="YYYY" />
                        ...
                        <div>
                            ...
                            <x-text-input id="category"
                                class="block mt-1 w-full !border-slate-300 focus:!border-slate-500 focus:!ring-slate-500"
                                type="text" name="category" :value="old('category')" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="project_url"
                                class="block mt-1 w-full !border-slate-300 focus:!border-slate-500 focus:!ring-slate-500"
                                type="url" name="project_url" :value="old('project_url')"
